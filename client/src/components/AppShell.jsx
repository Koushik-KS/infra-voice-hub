  ...
  return (
    <div className="flex h-full flex-col bg-sidebar text-sidebar-foreground">
      ...
      <div className="flex items-center gap-3 border-b border-sidebar-border px-5 py-5">
        <span className="flex size-10 items-center justify-center rounded-xl bg-primary/20 text-primary ring-1 ring-sidebar-border">
          <Landmark className="size-5" />
        </span>

        <div className="min-w-0">
          <p className="truncate text-base font-bold text-sidebar-accent-foreground">
            CivilIntel
          </p>
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-4">
        <p className="px-2 pb-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-sidebar-foreground/50">
          Intelligence
        </p>
      ...
      <div className="border-t border-sidebar-border px-3 py-4">
        ...
        >
          <Settings className="size-4 shrink-0 transition-transform duration-200 group-hover:rotate-45" />
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute inset-y-0 left-0 w-72 max-w-[85%] shadow-[var(--shadow-elevated)]">
            <button
              ...
              className="absolute right-3 top-4 z-10 rounded-lg p-1.5 text-sidebar-foreground/80 hover:bg-sidebar-accent"
            >
              <X className="size-4" />
            </button>
